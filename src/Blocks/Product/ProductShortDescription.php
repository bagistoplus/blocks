...
class ProductShortDescription extends Text
{
    protected static string $view = 'basic-blocks::blocks.product.short-description';

    protected static string $type = '@basic-blocks/product-short-description';
    ...
    {
        return _t('blocks.product-short-description.name');
    }
